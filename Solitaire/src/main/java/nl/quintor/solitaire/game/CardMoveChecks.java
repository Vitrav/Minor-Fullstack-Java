...
public class CardMoveChecks {
    ...
    public static void deckLevelChecks(Deck sourceDeck, int sourceCardIndex, Deck destinationDeck) throws MoveException {
        // TODO: Write implementation  To Verify
        if(sourceDeck.getDeckType() != destinationDeck.getDeckType()){
            cardLevelChecks(sourceDeck, sourceDeck.get(sourceCardIndex));
        }
        else{
            throw new MoveException("Not able to do this move");
        }
